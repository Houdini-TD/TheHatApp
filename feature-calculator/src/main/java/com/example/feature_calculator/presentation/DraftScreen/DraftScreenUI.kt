    ...
    Scaffold(
        ...
        Box(modifier = Modifier.padding(it)) {
            Column(
                ...
                OutlinedButton(
                    border = BorderStroke(1.dp, CustomTheme.colors.text.noAccent),
                    colors = CustomTheme.m3Colors.buttonColors.secondary,
                    onClick = component::onNewGroupClick
                ) {
                    Row(
                        ...
                        Text(
                            ...
                            color = CustomTheme.colors.text.noAccent
                        )
                        ...
                        Icon(
                            ...
                            tint = CustomTheme.colors.text.noAccent,
                            contentDescription = ""
                        )
                    }
                }
